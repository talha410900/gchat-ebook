        ...
        <div className='max-w-[320px] md:max-w-[1100px] lg:max-w-[1475px] mx-auto max-h-full h-[697px] md:h-[100vh]'>
          <div className='flex flex-col md:flex-row justify-between md:px-10 lg:px-20'>
            <div className='mt-2.5 md:mt-[89px] md:w-[500px] lg:w-[670px]'>
              ...
              <h1 className='text-2xl md:text-[30px] lg:text-[57px] px-0 text-center md:text-start  font-inter font-bold  text-white md:mt-12 lg:mt-[76px] leading-[1.15]'>
                Viete už, ako využiť
                <br />
              ...
              <div className='flex flex-col lg:flex-row items-center lg:gap-10'>
                <button className='text-white text-lg font-semibold flex items-center gap-4 rounded-[100px] bg-green button-shadow px-11 py-4'>
