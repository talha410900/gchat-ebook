                                ...
                                {steps === 1 ?
                                    <>
                                        <Dialog.Panel className="w-full h-[442px] lg:h-[606px] max-w-[267px] md:max-w-[500px] lg:max-w-[624px] transform overflow-hidden rounded-2xl bg-white px-4 pb-5 pt-2 lg:p-8 text-left align-middle shadow-xl transition-all text-gray-100 relative">
                                            ...
                                            <Dialog.Title
                                                as="h3"
                                                className="text-2xl md:text-3xl lg:text-[42px] font-semibold leading-[46px] "
                                            >
                                                Stiahnuť E-Book
                                            </Dialog.Title>
                                            ...
                                            <div className='flex gap-2 border border-x-0 border-t-0 border-b-gray-300 items-center mt-2.5 h-8 lg:h-[52px] w-full'>
                                                <input type='email' required placeholder='Napíšte Vaše celé meno *' className='text-[10px] md:text-xs lg:text-base border-none outline-none' />
                                            </div>
                                            <div className='flex gap-2 border border-x-0 border-t-0 border-b-gray-300 items-center mt-4 h-8 lg:h-[52px] w-full'>
                                                <input type='email' required placeholder='Napíšte Váš E-Mail *' className='text-[10px] md:text-xs lg:text-base border-none outline-none' />
                                            </div>
                                            <div className='flex gap-2 border border-x-0 border-t-0 border-b-gray-300 items-center mt-4 h-8 lg:h-[52px] w-full'>
                                                <input type='number' required placeholder='Napíšte Vaše telefónne číslo *' className='text-[10px] md:text-xs lg:text-base border-none outline-none' />
                                            </div>
                                            <div className='flex gap-2 border border-x-0 border-t-0 border-b-gray-300 items-center mt-4 h-8 lg:h-[52px] w-full'>
                                                <input type='email' required placeholder='Napíšte názov Vašej web stránky www. *' className='text-[10px] md:text-xs lg:text-base border-none outline-none' />
                                            </div>
                                            ...
                                            <button
                                                onClick={handelSteps}
                                                className='text-white rounded-md text-sm md:text-xs lg:text-lg flex justify-center items-center gap-2 mt-3 lg:mt-4 bg-green button-shadow px-7 py-3.5 w-full'>
                                    ...
                                    steps === 2 ?
                                        <>
                                            <Dialog.Panel className="w-full h-[226px] lg:h-[369px] max-w-[267px] md:max-w-[500px] lg:max-w-[624px] transform overflow-hidden rounded-2xl bg-white px-4 pb-3.5 pt-2.5 lg:p-8 text-center align-middle shadow-xl transition-all text-gray-100 relative">
                                                ...
                                                <p className='lg:mt-1.5 lg:pb-4 text-[8px] md:text-sm lg:text-base'> Na Váš zadaný E-Mail <span className='underline'> bol zaslaný 4 číselný verifikačný kód.</span></p>

                                                <div className='mt-4 md:mt-5 flex flex-row gap-2 lg:gap-3 px-8 md:px-0 md:w-[180px] lg:w-[255px] mx-auto'>
                                        ...
                                        :
                                        <>
                                            <Dialog.Panel className="w-full h-[368px] md:h-[400px] lg:h-[515px] max-w-[267px] md:max-w-[500px] lg:max-w-[624px] transform overflow-hidden rounded-2xl bg-white px-4 pb-3.5 pt-2.5 lg:px-8 text-center align-middle shadow-xl transition-all text-gray-100 relative">
                                                <div  >
                                                ...
                                                <p className='mt-4 lg:px-[72px] text-[10px] md:text-sm lg:text-base'>Spolu s E-Bookum <span className='font-semibold'>ste získali ZDARMA 30 min konzultáciu s našim odborníkon na umelú inteligenciu.</span> Náš AI odborník Vás bude čoskoro kontaktovať.</p>

                                                <button
                                                    onClick={closeModal}
                                                    className='text-white rounded-md text-[11px] md:text-sm lg:text-lg flex justify-center items-center gap-2 mt-4 lg:mt-7 bg-green button-shadow px-7 py-3.5 w-full'>
                                                    G CHAT - AI pre web stránky
                                                </button>
                                                <Link href='https://www.wavenet.sk' className='mt-2.5 lg:mt-5 flex items-start text-[8px] md:text-sm lg:text-sm'>
