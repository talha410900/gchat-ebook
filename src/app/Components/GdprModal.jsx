        ...
        <div className="fixed inset-0 overflow-y-auto ">
          <div className=" flex min-h-full items-center justify-center text-center">
            ...
            >
              ...
              <Dialog.Panel className="w-full h-[378px] md:h-[400px] lg:h-[415px] overflow-y-auto max-w-[267px] md:max-w-[500px] lg:max-w-[624px] transform overflow-hidden rounded-t-2xl bg-white px-4 pb-5 pt-2 lg:pl-8 lg:pt-7 lg:pr-1.5 lg:pb-8  text-left align-middle shadow-xl transition-all text-grey-100 relative">
                ...
                <div className='mt-2 lg:mt-5'>
                  ...
                  <p className='text-[8px] md:text-xs text-grey-500'>Správca sa zaväzuje prijať vhodné technické a organizačné opatrenia k zabezpečeniu osobných údajov, aby nedošlo k neoprávnenému prístupu k týmto údajom alebo k ich strate. Správca prehlasuje, že k osobným údajom budú mať prístup len oprávnené osoby povinné zachovávať mlčanlivosť o osobných údajoch. Správca prijal technické opatrenia k zabezpečeniu dátových úložísk a osobným údajom evidovaným v listinnej podobe.</p>
                </div>

                <div className='mt-2 lg:mt-5'>
                  <h2 className='text-xs md:text-xm lg:text-base font-semibold'>7. ZÁVEREČNÉ USTANOVENIA</h2>
                  <p className='text-[8px] md:text-xs text-grey-500'>Odoslaním formuláru potvrdzujete, že ste sa s podmienkami ochrany osobných údajov oboznámili a bezvýhradne s nimi súhlasíte. Správca si vyhradzuje právo meniť tieto podmienky. Aktuálna verzia podmienok je zverejnená na internetových stránkach správcu.<br />
